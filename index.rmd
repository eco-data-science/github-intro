...
We all store GitHub repos in our home directory in a folder called ***'github'*** (all lowercase!), so that you can access it with the filepath `~/github`. 
...
## Workflow using RStudio

Demo:

1. **clone a repo** from github.com, then RStudio
2. **edit within the repo**: [test_script_ohi-uswest.Rmd](https://github.com/eco-data-science/github-intro/blob/master/sandbox/test_script_ohi-uswest.Rmd) in RStudio, then create a file in Excel
3. **commit**
4. **pull**
5. **push**
...
5. Clone [github-intro](https://github.com/OHI-Science/github-intro) repository to your computer
